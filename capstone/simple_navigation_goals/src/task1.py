...
class PatrolNav():
    def __init__(self):
        ...
        self.locations = dict()  
        self.locations['one']   = Pose(Point(-3.21071238502, 3.87769524294, 0.000), Quaternion(0.000, 0.000, -0.427437891224, 0.904044716342))
...
,  0.210183132334
        ...
        self.locations['four']  = Pose(Point(-6.64053727135
,  1.83428096783
, 0.000), Quaternion(0.000, 0.000, 0.263781278853
,0.964582519501))
...
, 0.000), Quaternion(0.000, 0.000, -0.442922315673, 0.896559993686
        ...
        self.locations['seven']  = Pose(Point(-4.43989029259
,-1.62836303784
, 0.000), Quaternion(0.000, 0.000,  -0.574893043802
,0.818228567204
))
